...
A **taxa de suicídio** é um indicador de saúde pública que mede o número de mortes por suicídio a cada 100 mil habitantes em determinado período. Essa taxa é amplamente utilizada por organizações internacionais, como a **Organização Mundial da Saúde (OMS)** e o **Banco Mundial**, para monitorar o bem-estar psicológico da população e orientar políticas de prevenção.

Globalmente, cerca de **700 mil pessoas morrem por suicídio todos os anos**, sendo essa uma das principais causas de morte entre jovens de 15 a 29 anos. A taxa tende a ser mais alta entre **homens**, embora **mulheres realizem mais tentativas**. No Brasil, os índices ficam entre 5 e 7 por 100 mil habitantes, abaixo da média mundial, mas com tendência de crescimento.

Fatores como **transtornos mentais, abuso de substâncias, desemprego, violência, isolamento social** e acesso fácil a meios letais estão diretamente relacionados ao aumento das taxas. Por isso, o suicídio deve ser compreendido não apenas como uma questão individual, mas também **social e estrutural**, exigindo ações coordenadas em saúde pública, educação e assistência social.

## GRÁFICO COM DADOS EM PAINEL

Tendência das taxas de suicídio masculino global (1990-2020). revela que, enquanto a média global (linha preta) permaneceu estável, países como a Rússia (vermelho) apresentaram taxas crescentes, contrastando com o Brasil (azul), que manteve índices abaixo da média."
...
O gráfico evidencia a concentração de taxas elevadas na Europa Oriental, com a Rússia (54.5) liderando. A ausência de países latino-americanos no Top 30 sugere que fatores regionais, como políticas de saúde mental, podem mitigar o problema.
...
O gráfico revela um aumento significativo de 46% nas taxas de suicídio masculino no Brasil entre 1990 e 2020 com crescimento especialmente acentuado na última década. Apesar de se manter abaixo da média global, a trajetória ascendente contrasta com países que implementaram políticas preventivas eficazes.
